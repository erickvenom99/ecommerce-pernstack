...
export default function CreateStore() {
        ...
        try {
            ...
            if(["approved", "pending", "rejected"].includes(data.status)){
                    ...
                    switch (data.status) {
                        case "approved":
                            setMessage(
                                "Your store has been approved, you can now add producto your store from dashboard"
                            )
                        ...
                        case "pending":
                            setMessage(
                                "Your store is pending, wait for admin to approve your request"
                            )
                            break;
    ...
    if(!user){
        <div className="min-h-[80vh] mx-6 flex items-center justify-center text-slate-400">
            <h1 className="text-2l sm:text-4xl font-semibold">Please ,<span className="text-slate-500">login</span> to contine</h1>
        </div>
    }
