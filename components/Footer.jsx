    ...
    const linkSections = [
        {
            title: "PRODUCTS",
            links: [
                { text: "Shirts", path: '/', icon: null },
                { text: "Snickers", path: '/', icon: null },
                { text: "Luxury Bags", path: '/', icon: null },
                { text: "Unique Hairs", path: '/', icon: null },
            ]
        },
        {
            title: "WEBSITE?",
            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        ...
                        <p className="max-w-[410px] mt-6 text-sm">Welcome to AllyBuy, your ultimate destination for the latest and smartest Fashion wears and Accessories. From clothes, Shoes, Snickers, Hairs  and jewelries to essential accessories, we bring you the best brands with latest wears and affordable prices — all in one place.</p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2025 © Ally-Buy All Right Reserved.
                </p>
            </div>
        </footer>
    );
