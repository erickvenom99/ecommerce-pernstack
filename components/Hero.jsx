    ...
    return (
        <div className='mx-6'>
            <div className='flex max-xl:flex-col gap-8 max-w-7xl mx-auto my-10'>
                <div className='relative flex-1 flex flex-col bg-amber-500 rounded-3xl xl:min-h-100 group'>
                    <div className='p-5 sm:p-16'>
                        ...
                        <h2 className='text-3xl sm:text-5xl leading-[1.2] my-3 font-medium bg-gradient-to-r from-slate-600 to-[#A0FF74] bg-clip-text text-transparent max-w-xs  sm:max-w-md'>
                            Brands you'll love. Prices you'll trust.
                        </h2>
                        <div className='text-slate-800 text-sm font-medium mt-4 sm:mt-8'>
                            <p>Starts from</p>
                            <p className='text-3xl'>{currency}4K</p>
                        </div>
                    ...
                    <Image className='sm:absolute bottom-0 right-0 md:right-5 w-full sm:max-w-sm height={40} width={60}' src={assets.model3} alt="" />
                </div>
                <div className='flex flex-col md:flex-row xl:flex-col gap-5 w-full xl:max-w-sm text-sm text-slate-600'>
                    <div className='flex-1 flex items-center justify-between w-full bg-green-300 rounded-3xl p-6 px-8 group'>
                        <div>
                            <p className='text-2xl font-medium bg-gradient-to-r from-slate-800 to-[#FFAD51] bg-clip-text text-transparent max-w-40'>Best Quality Human Hairs</p>
                            <p className='flex items-center gap-1 mt-4'>View more <ArrowRightIcon className='group-hover:ml-2 transition-all' size={18} /> </p>
                        </div>
                        <Image className='w-35' src={assets.unique_hair} alt="" />
                    </div>
                    <div className='flex-1 flex items-center justify-between w-full bg-black-200 rounded-3xl p-6 px-8 group'>
                        <div>
                        ...
                        <Image className='w-35' src={assets.red_snickers} alt="" />
                    </div>
                </div>
            </div>
            <CategoriesMarquee />
